...
function BusinessPageSmall(props) {
  return props.selectedBusiness ? (
    <>
      <div className="business-page-container-small">
        <div className="business-details-container">
          ...
          <div className="business-donation-container">
            ...
            <div className="business-donation-details-container small-container-spacing-set">
          ...
          <div className="business-details-body-container small-container-spacing-set">
